                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 30px;">
                                <tr>
                                    <td align="center">
                                        <a href="https://www.stageatehb.be/login" target="_blank" style="background-color: #4A90E2; color: #ffffff; padding: 14px 30px; font-size: 16px; font-weight: bold; text-decoration: none; border-radius: 5px; display: inline-block; box-shadow: 0 2px 5px rgba(74,144,226,0.3);">
                                            Direct Inloggen
                                        </a>
                                    </td>
                                </tr>
